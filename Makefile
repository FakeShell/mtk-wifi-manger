...
CFLAGS = `pkg-config --cflags gio-2.0 libnl-3.0 libandroid-properties` -Iinclude
LDFLAGS = `pkg-config --libs gio-2.0 libnl-genl-3.0 libandroid-properties`

SOURCES = src/main.c src/dbus.c src/wmt.c src/wpa.c src/ip.c
